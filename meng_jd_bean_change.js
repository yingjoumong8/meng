...
!(async() => {
	...
	for (i = 0; i < cookiesArr.length; i++) {
		if (cookiesArr[i]) {
			...
			if (!$.isLogin) {
				$.msg($.name, `【提示】cookie已失效`, `京东账号${$.index} ${$.nickName || $.UserName}${$.Remark}\n请重新登录获取\nhttps://bean.m.jd.com/bean/signIndex.action`, {
					"open-url": "https://bean.m.jd.com/bean/signIndex.action"
				});
...
async function showMsg() {
	...
	if (userIndex2 != -1) {
		IndexGp2 += 1;
		ReturnMessageTitle = `【账号${IndexGp2}🆔】${$.nickName || $.UserName}${$.Remark}\n`;
	}
	if (userIndex3 != -1) {
		IndexGp3 += 1;
		ReturnMessageTitle = `【账号${IndexGp3}🆔】${$.nickName || $.UserName}${$.Remark}\n`;
	}
	if (userIndex4 != -1) {
		IndexGp4 += 1;
		ReturnMessageTitle = `【账号${IndexGp4}🆔】${$.nickName || $.UserName}${$.Remark}\n`;
	}
	if (userIndex2 == -1 && userIndex3 == -1 && userIndex4 == -1) {
		IndexAll += 1;
		ReturnMessageTitle = `【账号${IndexAll}🆔】${$.nickName || $.UserName}${$.Remark}\n`;
	}
	...
	if ($.JdFarmProdName != "") {
		if ($.JdtreeEnergy != 0) {
			if ($.treeState === 2 || $.treeState === 3) {
				...
				if (userIndex2 != -1) {
					ReceiveMessageGp2 += `【账号${IndexGp2} ${$.nickName || $.UserName}${$.Remark}】${$.JdFarmProdName} (东东农场)\n`;
				}
				if (userIndex3 != -1) {
					ReceiveMessageGp3 += `【账号${IndexGp3} ${$.nickName || $.UserName}${$.Remark}】${$.JdFarmProdName} (东东农场)\n`;
				}
				if (userIndex4 != -1) {
					ReceiveMessageGp4 += `【账号${IndexGp4} ${$.nickName || $.UserName}${$.Remark}】${$.JdFarmProdName} (东东农场)\n`;
				}
				if (userIndex2 == -1 && userIndex3 == -1 && userIndex4 == -1) {
					allReceiveMessage += `【账号${IndexAll} ${$.nickName || $.UserName}${$.Remark}】${$.JdFarmProdName} (东东农场)\n`;
				}
			} else {
			...
			if ($.treeState === 0) {
				...
				if (userIndex2 != -1) {
					WarnMessageGp2 += `【账号${IndexGp2} ${$.nickName || $.UserName}${$.Remark}】水果领取后未重新种植! (东东农场)\n`;
				}
				if (userIndex3 != -1) {
					WarnMessageGp3 += `【账号${IndexGp3} ${$.nickName || $.UserName}${$.Remark}】水果领取后未重新种植! (东东农场)\n`;
				}
				if (userIndex4 != -1) {
					WarnMessageGp4 += `【账号${IndexGp4} ${$.nickName || $.UserName}${$.Remark}】水果领取后未重新种植! (东东农场)\n`;
				}
				if (userIndex2 == -1 && userIndex3 == -1 && userIndex4 == -1) {
					allWarnMessage += `【账号${IndexAll} ${$.nickName || $.UserName}${$.Remark}】水果领取后未重新种植! (东东农场)\n`;
				}
				...
				if (userIndex2 != -1) {
					WarnMessageGp2 += `【账号${IndexGp2} ${$.nickName || $.UserName}${$.Remark}】状态异常! (东东农场)\n`;
				}
				if (userIndex3 != -1) {
					WarnMessageGp3 += `【账号${IndexGp3} ${$.nickName || $.UserName}${$.Remark}】状态异常! (东东农场)\n`;
				}
				if (userIndex4 != -1) {
					WarnMessageGp4 += `【账号${IndexGp4} ${$.nickName || $.UserName}${$.Remark}】状态异常! (东东农场)\n`;
				}
				if (userIndex2 == -1 && userIndex3 == -1 && userIndex4 == -1) {
					allWarnMessage += `【账号${IndexAll} ${$.nickName || $.UserName}${$.Remark}】状态异常! (东东农场)\n`;
				}
	...
	if ($.DdFactoryReceive) {
		if (userIndex2 != -1) {
			ReceiveMessageGp2 += `【账号${IndexGp2} ${$.nickName || $.UserName}${$.Remark}】${$.DdFactoryReceive} (东东工厂)\n`;
		}
		if (userIndex3 != -1) {
			ReceiveMessageGp3 += `【账号${IndexGp3} ${$.nickName || $.UserName}${$.Remark}】${$.DdFactoryReceive} (东东工厂)\n`;
		}
		if (userIndex4 != -1) {
			ReceiveMessageGp4 += `【账号${IndexGp4} ${$.nickName || $.UserName}${$.Remark}】${$.DdFactoryReceive} (东东工厂)\n`;
		}
		if (userIndex2 == -1 && userIndex3 == -1 && userIndex4 == -1) {
			allReceiveMessage += `【账号${IndexAll} ${$.nickName || $.UserName}${$.Remark}】${$.DdFactoryReceive} (东东工厂)\n`;
		}
		TempBaipiao += `【东东工厂】${$.ddFactoryInfo} 可以兑换了!\n`;
	}
	if ($.jxFactoryReceive) {
		if (userIndex2 != -1) {
			ReceiveMessageGp2 += `【账号${IndexGp2} ${$.nickName || $.UserName}${$.Remark}】${$.jxFactoryReceive} (京喜工厂)\n`;
		}
		if (userIndex3 != -1) {
			ReceiveMessageGp3 += `【账号${IndexGp3} ${$.nickName || $.UserName}${$.Remark}】${$.jxFactoryReceive} (京喜工厂)\n`;
		}
		if (userIndex4 != -1) {
			ReceiveMessageGp4 += `【账号${IndexGp4} ${$.nickName || $.UserName}${$.Remark}】${$.jxFactoryReceive} (京喜工厂)\n`;
		}
		if (userIndex2 == -1 && userIndex3 == -1 && userIndex4 == -1) {
			allReceiveMessage += `【账号${IndexAll} ${$.nickName || $.UserName}${$.Remark}】${$.jxFactoryReceive} (京喜工厂)\n`;
		}
	...
	if (initPetTownRes.code === '0' && initPetTownRes.resultCode === '0' && initPetTownRes.message === 'success') {
		...
		if ($.petInfo.userStatus === 0) {
			...
			if (userIndex2 != -1) {
				ReceiveMessageGp2 += `【账号${IndexGp2} ${$.nickName || $.UserName}${$.Remark}】${$.petInfo.goodsInfo.goodsName}可以兑换了! (东东萌宠)\n`;
			}
			if (userIndex3 != -1) {
				ReceiveMessageGp3 += `【账号${IndexGp3} ${$.nickName || $.UserName}${$.Remark}】${$.petInfo.goodsInfo.goodsName}可以兑换了! (东东萌宠)\n`;
			}
			if (userIndex4 != -1) {
				ReceiveMessageGp4 += `【账号${IndexGp4} ${$.nickName || $.UserName}${$.Remark}】${$.petInfo.goodsInfo.goodsName}可以兑换了! (东东萌宠)\n`;
			}
			if (userIndex2 == -1 && userIndex3 == -1 && userIndex4 == -1) {
				allReceiveMessage += `【账号${IndexAll} ${$.nickName || $.UserName}${$.Remark}】${$.petInfo.goodsInfo.goodsName}可以兑换了! (东东萌宠)\n`;
			}
		} else if ($.petInfo.petStatus === 6) {
			TempBaipiao += `【东东萌宠】未选择物品! \n`;
			if (userIndex2 != -1) {
				WarnMessageGp2 += `【账号${IndexGp2} ${$.nickName || $.UserName}${$.Remark}】未选择物品! (东东萌宠)\n`;
			}
			if (userIndex3 != -1) {
				WarnMessageGp3 += `【账号${IndexGp3} ${$.nickName || $.UserName}${$.Remark}】未选择物品! (东东萌宠)\n`;
			}
			if (userIndex4 != -1) {
				WarnMessageGp4 += `【账号${IndexGp4} ${$.nickName || $.UserName}${$.Remark}】未选择物品! (东东萌宠)\n`;
			}
			if (userIndex2 == -1 && userIndex3 == -1 && userIndex4 == -1) {
				allWarnMessage += `【账号${IndexAll} ${$.nickName || $.UserName}${$.Remark}】未选择物品! (东东萌宠)\n`;
			}
			...
			if (userIndex2 != -1) {
				WarnMessageGp2 += `【账号${IndexGp2} ${$.nickName || $.UserName}${$.Remark}】暂未选购新的商品! (东东萌宠)\n`;
			}
			if (userIndex3 != -1) {
				WarnMessageGp3 += `【账号${IndexGp3} ${$.nickName || $.UserName}${$.Remark}】暂未选购新的商品! (东东萌宠)\n`;
			}
			if (userIndex4 != -1) {
				WarnMessageGp4 += `【账号${IndexGp4} ${$.nickName || $.UserName}${$.Remark}】暂未选购新的商品! (东东萌宠)\n`;
			}
			if (userIndex2 == -1 && userIndex3 == -1 && userIndex4 == -1) {
				allWarnMessage += `【账号${IndexAll} ${$.nickName || $.UserName}${$.Remark}】暂未选购新的商品! (东东萌宠)\n`;
			}
	...
	if ($.isNode() && WP_APP_TOKEN_ONE) {
		...
		ReturnMessage=`【账号名称】${$.nickName || $.UserName}${$.Remark}\n`+ReturnMessage;
